...
describe("Login Function Test", () => {
  it("should return 200 if login successfully with correct credentials", async () => {
  ...
  it("should return 400 if required fields are missing", async () => {
    ...
    expect(res.json.calledWithMatch({ description: "Missing required fields" })).to.be.true;
  });
...
describe("Register Function Test", () => {
  it("should return 201 if register a new account successfully", async () => {
  ...
  it("should return 405 if passwords mismatch", async () => {
    ...
    expect(res.json.calledWithMatch({ description: "Passwords mismatch" })).to.be.true;
  });
  ...
  it("should return 406 if email already exists", async () => {
    ...
    expect(res.json.calledWithMatch({ description: "Email already exists" })).to.be.true;
  });
  ...
  it("should return 409 when register is called while already logged in", async () => {
    ...
    expect(res.json.calledWithMatch({ description: "User has already logged in" })).to.be.true;
  });
...
describe("Logout Function Test", () => {
  it("should return 200 if logout successfully with valid token", async () => {
    const mockUserId = new mongoose.Types.ObjectId();
    ...
    sinon.stub(User, "findByIdAndUpdate").resolves({ tokenVersion: 1 });
    ...
    expect(res.json.calledWithMatch({ description: "Successfully" })).to.be.true;
  });
...
describe("Admin Panel Middleware Test", () => {
  it("should return 401 if guest tries to access admin panel", () => {
    const req = { user: null };
  ...
  it("should return 403 if normal user tries to access admin panel", () => {
...
describe("Get My Reviews Function Test", () => {
  it("should return 200 and load reviews for logged-in user", async () => {
    const mockUserId = new mongoose.Types.ObjectId();
    ...
    expect(res.json.firstCall.args[0].data[0]).to.have.property("reviewID", mockReviewId);
  });
...
describe("Write Review Function Test", () => {
  it("should return 201 if create a new review successfully", async () => {
    const mockUserId = new mongoose.Types.ObjectId();
  ...
  it("should return 408 if album not found when choosing album to write a review for", async () => {
    const mockUserId = new mongoose.Types.ObjectId();
...
describe("Update Review Function Test", () => {
  it("should return 200 and update the review if user is the owner", async () => {
    const mockUserId = new mongoose.Types.ObjectId();
    const mockReviewId = new mongoose.Types.ObjectId();
    ...
    findByIdStub.onSecondCall().returns({ populate: sinon.stub().returnsThis() });
  ...
  it("should return 403 if not owner edits review", async () => {
    ...
    sinon.stub(Review, "findById").resolves({ _id: mockReviewId, userID: mockOwnerId });
  ...
  it("should return 404 if review not found to edit", async () => {
    const mockUserId = new mongoose.Types.ObjectId();
    ...
    expect(res.json.calledWithMatch({ description: "Review not found" })).to.be.true;
  });
...
describe("Delete Review Function Test", () => {
  it("should return 200 and delete review if user is owner", async () => {
    const mockUserId = new mongoose.Types.ObjectId();
    const mockReviewId = new mongoose.Types.ObjectId();
...
describe("Admin Get All Reviews Function Test", () => {
  it("should return 200 when admin get all reviews", async () => {
    const mockReviewId = new mongoose.Types.ObjectId();
    const mockUserId = new mongoose.Types.ObjectId();
    const mockAlbumId = new mongoose.Types.ObjectId();
...
describe("Admin Delete Review Function Test", () => {
  ...
  it("should return 404 when the review is not found to delete", async () => {
...
describe("Get Album By AlbumId Function Test", () => {
  it("should return 200 if album found successfully", async () => {
    const mockAlbumId = new mongoose.Types.ObjectId();

    const req = {
      params: { id: mockAlbumId },
    };
    ...
    sinon.stub(Album, "findById").resolves(mockAlbum);
  ...
  it("should return 408 if album not found when getting album by AlbumId", async () => {
    const fakeAlbumId = new mongoose.Types.ObjectId();

    const req = {
      params: { id: fakeAlbumId },
    };
...
describe("Get Reviews By Album Function Test", () => {
  it("should return 200 if found reviews for the album", async () => {
    const mockAlbumId = new mongoose.Types.ObjectId();
    const mockUserId = new mongoose.Types.ObjectId();
    const mockReviewId = new mongoose.Types.ObjectId();

    const req = {
      params: { albumID: mockAlbumId },
    };
    ...
    const mockReviews = [
      {
        _id: mockReviewId,
        albumID: { title: "Test Album", artist: "Test Artist", coverImageUrl: "url" },
        userID: { nickname: "user", email: "user@test.com", type: "user" },
        reviewRate: 5,
        reviewContent: "Great album!",
        createdAt: new Date(),
    ...
    sinon.stub(Review, "find").returns({
      populate: sinon.stub().returnsThis(),
      sort: sinon.stub().resolves(mockReviews),
    });
    ...
    await reviewController.getReviewsByAlbum(req, res);
  ...
  it("should return 408 if album not found when getting reviews by albumId", async () => {
    const fakeAlbumId = new mongoose.Types.ObjectId();

    const req = {
      params: { albumID: fakeAlbumId },
    };
